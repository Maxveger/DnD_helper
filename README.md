...
Деморежим не ограничен таймером или числом действий: приключение можно пройти до финала. Быстрые кнопки учитывают персонажа, цель и состояние мира; причина недоступности написана под кнопкой. После выбора подтвердите исход кнопкой «Продолжить», а при проверке сначала введите или бросьте кубик. Без GPT свободный текст распознаётся только по небольшому словарю; неизвестное действие требует выбора ведущего.
