...
Откройте **«Помощник ведущего»**. Вы ведёте игру за столом: вводите заявку выбранного игрока или свой вопрос. **Luna готовит карточку одним запросом**, включая обе ветки броска. Бросок, правки, подтверждение и известные переходы работают без модели. Программа хранит факты, HP и вещи; решение и чтение реплики остаются ведущему.
