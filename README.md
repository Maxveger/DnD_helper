...
Для нового режима выбран **Codex CLI с подпиской ведущего**; API останется отдельно выбираемой альтернативой с лимитом $5 на сессию. Потребуются установка Codex и вход ведущего в собственный аккаунт. Этот адаптер и свободный мир **ещё не реализованы**; текущие настройки GPT по-прежнему работают через API. Для голоса согласовано отдельное распознавание через API в том же бюджете. [Обновлённое ТЗ](docs/FREE_WORLD_SPEC.md) · [Подключение Codex: требования](docs/CODEX_PROVIDER.md).
