...
def exercise(url, output):
    ...
    with sync_playwright() as p:
        ...
        page.locator("#primary-action").click()
        expect(page.locator("[data-intent=install]")).to_be_disabled()
        expect(page.locator("#reason-install")).to_contain_text("мастерской")
        expect(page.locator("[data-intent=start_pump]")).to_be_disabled()
        page.locator("[data-intent=inspect]").click()
        expect(page.locator("#primary-action")).to_contain_text("Попросить бросок")
        expect(page.locator("[data-intent=read]")).to_be_disabled()
        page.locator("#primary-action").click()
        page.reload()
        ...
        page.locator("#primary-action").click()
        expect(page.locator("[data-intent=inspect]")).to_be_disabled()
        ...
        page.reload()
        expect(page.locator("#scene-change")).to_be_disabled()
        ...
        expect(page.locator("#queue-count")).to_have_text("0")
        expect(page.locator("#scene-change")).to_be_enabled()
