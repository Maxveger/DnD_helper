...
Этот документ описывает текущую реализацию. Будущее расширение с постоянной памятью мира и свободной импровизацией описано отдельно в [HYBRID_WORLD.md](HYBRID_WORLD.md). Сначала доводим текущий интерфейс по [ближайшему плану](NEXT_STEPS.md).
